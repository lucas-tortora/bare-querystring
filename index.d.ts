 ...
 * @returns An object (with a `null` prototype) mapping decoded keys to decoded values; repeated keys collect into an array.
 */
 ...
 * @param params - Object whose enumerable entries become key/value pairs; array values produce one pair per element.
